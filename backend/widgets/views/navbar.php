                   ...
                   aria-expanded="false">
                    <div class="admin-title">
                        ...
                        if (!Yii::$app->user->isGuest) {
                            ...
                            echo "<h5 class='item-title'>$username</h5>";
                        } else {
                            // Handle the case when the user is a guest (not logged in)
                            echo "<h5 class='item-title'>Guest User</h5>";
                        }
                        ?>
                    </div>
                    <div class="admin-img">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="item-content">
                        <ul class="settings-list">
                            ...
                            <li>
                                <a href="<?= \yii\helpers\Url::to(['site/logout'])?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
